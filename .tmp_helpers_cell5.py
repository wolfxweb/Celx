...
# Nenhuma etapa chama arquivos externos via subprocess para o pipeline.
...
def prepare_sql_spider(config_path: Path, root: Path | None = None) -> dict[str, Any]:
...
def prepare_codexglue_dataset(config_path: Path, root: Path | None = None) -> dict[str, Any]:
...
print(
    ...
    "build_sft_bilingual_curated, document_code, inventory_datasets",
)
